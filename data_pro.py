...
def transformC(root, dist, filename):
    ...
    score = music21.converter.parse(root+filename)
...
if __name__ == '__main__':
    ...
    rootdir = "C:\\Users\\v-honzhu\\Desktop\\data_3\\data_3\\"
    dist = "C:\\Users\\v-honzhu\\Desktop\\c_data\\"
    ...
    for p, d, filenames in os.walk(rootdir):
        for filename in filenames:
            try:
                transformC(rootdir, dist, filename)
                count += 1
                print(count)
            except:
                print(filename)